...
def recommend_container_solution():
    ...
    msg_container_solution = intl_msg(
            ...
            If you are using the Container Service for Kubernetes (ACK) of Alibaba Cloud, we recommend the following resolution:
                ...
                6. Disable the old mount target.
                7. Make sure the workload is not affected and runs normally.
                8. Delete the old mount target.
            If you are using any other container management systems, we recommend the following resolution:
                ...
                5. Gradually desert the old container management system.
            The two methods above both use the new FlexVolume plug-in, which sets the noresvport option automatically when mounting a NAS volume, and these are the simplest resolutions available.
